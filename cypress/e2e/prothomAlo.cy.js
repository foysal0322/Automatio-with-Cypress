...
function login(email, password) {
  // it will logging in wuth the given credential
...
function logout(){
  // it will logging out the current user
...
function navigate_homepage(){
  cy.viewport(1920, 1080) // expanding the webpage in full screen since webeelement might collapse in small screen
...
it('Navigate to about us',() =>{
  ...
  cy.title().should('eq','Get to Know About Us | pickaboo.com') //validate with page title
